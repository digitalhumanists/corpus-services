 ...
 * @author fsnv625
 */
public class ISOTEI2ESJSON extends Converter implements CorpusFunction {
    ...
    //locations of the used xsl
    static String XSL_STYLESHEET = "/xsl/ISOTEI2ESJSON.xsl";
    ...
    CorpusIO cio = new CorpusIO();
        ...
        public ISOTEI2ESJSON() {
        super("TEI2ELASTICJSON");
    }
